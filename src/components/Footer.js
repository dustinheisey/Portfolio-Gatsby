    ...
    <footer className="bg-p-d padding-lg width-p-lg display-f direction-r justify-sa height-a">
      <div className="width-p-md display-f direction-c t-justify-se">
        ...
        <p className="color-l margin-t-md text-md">
          My name is Dustin Heisey. I'm a web and user experience designer
          located in Dallas, TX. I help you make more money by creating an
          online presence that your users want to use.
        </p>
        <Link to="/" className="color-l text-md margin-tb-sm">
...
const FooterLink = ({ link, text }) => {
  return (
    <li className="margin-tb-sm">
      <Link to={link} className="background color-l text-md padding-sm">
        {text}
      </Link>
    </li>
  )
