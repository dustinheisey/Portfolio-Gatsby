...
const Button = ({ external, link, text, classes }) => {
  if (external) {
    return (
      <a
        className={`border-r-md padding-lr-md padding-tb-sm d-padding-lr-md d-padding-tb-sm display-i align-c justify-l cursor-p grow outline-n border-n color-l cursor-p text-md ${
