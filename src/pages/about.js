    ...
    <Layout>
      <main className="about padding-lg">
        ...
        <Info classes="about-blurb display-f direction-r align-c justify-se">
          ...
          />
          <h1 className="text-lg margin-b-sm">Hey, my name is Dustin</h1>
          <p className="text-md">
            I'm a Freelance web and user experience designer, located in Dallas,
            Texas. Your problems are my problems, and I have the tools and
            insight to help you solve them, while also helping your users solve
            their own.
          </p>
        </Info>
        ...
        <Info classes="about-skills justify-l">
          ...
          <div className="display-g direction-c align-l margin-b-md about-skills-grid">
            <div className="display-f direction-r align-c margin-b-sm">
              ...
              <h3 className="text-md">Responsive Web Design</h3>
            </div>
            <div className="display-f direction-r align-c margin-b-sm">
              <svg
                fill="#F79F1F"
              ...
              <h3 className="text-md">User Experience Design</h3>
            </div>
            <div className="display-f direction-r align-c margin-b-sm">
              <svg
                className="width-v-sm t-width-v-xsm margin-r-md d-margin-r-sm margin-b-sm"
            ...
            <div className="display-f direction-r align-c margin-b-sm">
              ...
              <h3 className="text-md">Progressive Web Apps</h3>
            </div>
            <div className="display-f direction-r align-c">
              ...
              <h3 className="text-md">Website Optimization</h3>
            </div>
          </div>
        </Info>

        <Info classes="about-intro">
          <h2 className="text-lg margin-b-sm">What makes me different?</h2>
          <p className="text-md">
            There are many web designers to work on your next project with you.
            Find out how you need to work with me if your goal is to make the
            most money below.
          </p>
        </Info>

        <Info classes="about-user">
          <h2 className="text-lg margin-b-md">My designs are user centric</h2>
          <p class="text-md margin-b-lg">
            When I design websites I take great care in intimately understanding
            your target market. I determine your user's goals and design
            experiences that help achieve them with the least friction possible.
            I learn the aesthetic preferences of the users and design
            experiences that evoke pleasant feelings while they are using your
            site.
          </p>
          <h3 className="text-xmd margin-b-md">Why this matters</h3>
          <p class="text-md">
            Your users are responsible for your success. They are your clients,
            your customers, your donors, your partners. Your success is
            dependant on their reactions. By prioritizing the user's needs you
            are making a significant investment into your company, one that if
            not made will have equally significant consequences.
          </p>
        </Info>
        ...
        <Info classes="about-business">
          ...
          <p class="text-md margin-b-lg">
            You have a goal in mind when we work on a project together, and I
            focus on that goal throughout the entire process of designing and
            developing your site. I am also paying attention to the user's goals
            when they come to your website, and it is my job to create harmony
            between both. I direct users to the conversion we've defined in the
            most clear, aesthetic, and effective way possible, all in efforts to
            get you closer to your goals.
          </p>
          <h3 className="text-xmd margin-b-md">Why this matters</h3>
          <p class="text-md">
            By giving users clear direction as to what they are supposed to do
            when the arrive on your site, and by guiding them to this action,
            they are significantly more likely to take the action, and they are
            significantly more likely to enjoy doing so.
          </p>
        </Info>
        ...
        <Info classes="about-responsive">
          ...
          <p class="text-md margin-b-lg">
            A little while ago we lived in a single device society, where one
            individual has one technological device, namely a computer. We have
            since migrated to a multiple device society, where each individual
            has multiple devices, and even where multiple people share a single
            device, such as in the case of smart tvs. I make sure that your
            website looks beautiful on every one of the many devices your users
            are viewing it from. I understand the context of usage on each of
            these devices, and take that into account to create experiences that
            look specifically made for each of the devices that it is viewed on.
          </p>
          <h3 className="text-xmd margin-b-md">Why this matters</h3>
          <p class="text-md">
            You don't know which device a user will view your site on first, and
            if they get a wrong first impression, then you have lost a lead. By
            making your website look great everywhere, users from all devices
            will have every reason to take your conversion action.
          </p>
        </Info>
        ...
        <Info classes="about-fast">
          ...
          <p class="text-md margin-b-lg">
            Speed is an increasingly important issue in today's web design. As
            users begin to demand more and more from the websites they use,
            websites have gotten bigger and bigger, and slower and slower. I
            utilize powerful technologies to optimize your images, text,
            styling, code, well, everything. This results in websites that load
            almost instantly, a breath of fresh air in a internet full of slow
            experiences.
          </p>
          <h3 className="text-xmd margin-b-md">Why this matters</h3>
          <p class="text-md">
            The web is a big place, and users have the luxury of being able to
            go to another website if your site isn't fast enough. This is one of
            the most important aspects of usability because a sites speed has a
            direct correlation with a positive or negative reaction from the
            user. Having a fast site keeps your users happy long enough to get
            them to contact or buy from you.
          </p>
        </Info>

        <Info name="about-contact display-f direction-c align-c">
          <h2 className="margin-b-sm">Now let's talk about you</h2>
          <p className="margin-b-sm text-md">
            Now that you've learned about me, I wanna get to know you and your
            project
          </p>
          <Button
