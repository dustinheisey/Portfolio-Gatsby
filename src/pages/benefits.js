    ...
    <Layout>
      <main className="benefits padding-lg">
        ...
        <Info name="benefits-intro">
          <h1 className="margin-b-md">Benefits of Owning a Website</h1>
        ...
        <Info name="benefits-demand">
          ...
          <p className="margin-b-md color-m">
            By owning a website, you expand your reach from your local area to
            potentially the entire world. It doesn't matter how amazing your
            product or service is if nobody knows about it. Owning a website
            makes many more people aware of your wonderful company.
          </p>
        </Info>

        <Info name="benefits-questions">
          <h2 className="margin-b-md">Gives Users Answers Immediately</h2>
          <p className="margin-b-md color-m">
            Customers prefer to have their questions answered as soon as
            possible. With a website you can direct them to those answers
        ...
        <Info name="benefits-competitors">
          ...
          <p className="margin-b-md color-m">
            In 2018 it has become a standard for companies of all industries to
            have their own website. If you don't follow this trend, your
            competitors will. Attract your customers by getting a website before
            your competitors do.
          </p>
        </Info>
        ...
        <Info name="benefits-contact">
          ...
          <p className="margin-b-md color-m">
            There are so many benefits to owning your own website. Contact me
            and I can tell you a little more about them.
          </p>
